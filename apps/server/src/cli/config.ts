...
export const baseDirFlag = Flag.String("base-dir").pipe(
  Flag.withDescription(
    "Explicit T3 Code data directory; runtime state is stored under userdata (equivalent to T3TODO_HOME).",
  ),
  Flag.optional,
);
...
const EnvServerConfig = Config.all({
  ...
  t3Home: Config.String("T3TODO_HOME").pipe(Config.option, Config.map(Option.getOrUndefined)),
