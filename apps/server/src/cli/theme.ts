...
const envT3Home = Config.String("T3TODO_HOME").pipe(Config.option);

const resolveThemePaths = Effect.fn(function* (explicitBaseDir: Option.Option<string>) {
  // Same precedence as the rest of the CLI: --base-dir, then T3TODO_HOME,
  // then the default home. A provisioning script exporting T3TODO_HOME must
