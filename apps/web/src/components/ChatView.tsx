...
function resolveInitialAnchorViewOffset(
  ...
  if (!state || typeof anchorRowTop !== "number" || !Number.isFinite(anchorRowTop)) {
    return CHAT_LIST_ANCHOR_OFFSET;
  }
  ...
  return target ? anchorRowTop - target.scrollTarget : CHAT_LIST_ANCHOR_OFFSET;
}
        ...
        requestAnimationFrame(() => {
          ...
          void list
            .scrollToIndex({
              ...
              animated: true,
              viewPosition: 0,
              viewOffset: resolveInitialAnchorViewOffset(list, anchorIndex, composerOverlayHeight),
            })
            .then(() => {
              if (positionedTimelineAnchorRef.current !== messageId) {
                return;
                      ...
                      <div className="chat-composer-glass-host relative z-10 w-full rounded-[22px]">
                        <div ref={attachDraftHeroComposerAnchorRef} className="relative z-10">
                          <ChatComposer
                            ...
                            historyMessages={timelineMessages}
                            isServerThread={isServerThread}
