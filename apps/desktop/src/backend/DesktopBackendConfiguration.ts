...
const resolvePrimaryStartConfig = Effect.fn("desktop.backendConfiguration.resolvePrimary")(
  ...
  > {
    ...
    return {
      ...
      // Primary wants process.env (PATH, dev-runner's T3TODO_HOME, etc.).
      extendEnv: true,
      bootstrap,
...
> {
  ...
  // Build an explicit copy of process.env minus T3TODO_HOME (dev-runner
  ...
  const baseConfig = {
    ...
    // env is already a complete process.env minus T3TODO_HOME; pass it
